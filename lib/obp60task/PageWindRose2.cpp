...
class PageWindRose2 : public Page
{
bool keylock = false;               // Keylock
int16_t lp = 80;                    // Pointer length

public:
    PageWindRose2(CommonData &common){
        common.logger->logDebug(GwLog::LOG,"Show PageWindRose2");
    }
    ...
    virtual void displayPage(CommonData &commonData, PageData &pageData)
    {
        ...
        LOG_DEBUG(GwLog::LOG,"Drawing at PageWindRose2, %s:%f,  %s:%f,  %s:%f,  %s:%f,  %s:%f,  %s:%f", name1.c_str(), value1, name2.c_str(), value2, name3.c_str(), value3, name4.c_str(), value4, name5.c_str(), value5, name6.c_str(), value6);
...
static Page *createPage(CommonData &common){
    return new PageWindRose2(common);
}
/**
 ...
 */
PageDescription registerPageWindRose2(
    "WindRose2",         // Page name
    createPage,         // Action
