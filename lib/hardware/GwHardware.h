...
//ATOMS3 with PortABC
#ifdef BOARD_M5ATOMS3_MULTI
#define ESP32_CAN_TX_PIN GROOVE_PIN_2
#define ESP32_CAN_RX_PIN GROOVE_PIN_1
#define GWLED_BRIGHTNESS 64
//PortA (i2c)
#define GWIIC_SCL GPIO_NUM_39
#define GWIIC_SDA GPIO_NUM_38
//PortB (Serial 1)
#define GWSERIAL_TX GPIO_NUM_7
#define GWSERIAL_RX GPIO_NUM_8
#define GWSERIAL_TYPE GWSERIAL_TYPE_BI
//PortC (Serial 2)
#define GWSERIAL2_TX GPIO_NUM_5
#define GWSERIAL2_RX GPIO_NUM_6
